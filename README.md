...
```scala
libraryDependencies += "net.cakesolutions" %% "scala-kafka-client" % "0.9.0.0"
```
...
```scala
libraryDependencies += "net.cakesolutions" %% "scala-kafka-client-akka" % "0.9.0.0"
```
...
```scala
libraryDependencies += "net.cakesolutions" %% "scala-kafka-client-testkit" % "0.9.0.0" % "test"
```
