...
import cakesolutions.kafka.akka.KafkaConsumerActor.{Confirm, TriggerConsumerFailure, Unsubscribe}
import cakesolutions.kafka.{KafkaConsumer, KafkaProducerRecord, KafkaTopicPartition, Subscribe}
